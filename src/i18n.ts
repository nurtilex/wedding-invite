...
const dict = {
  kg: {
    ...
    // Традиционная форма: приглашают родители, «балдарыбыз» = наши дети.
    // {names} заменяется на config.namesGenitive и выводится отдельной строкой.
    inviteLong:
      'Сиздерди балдарыбыз {names} үйлөнүү үлпөт тоюнун кадырлуу коногу болуп, ' +
      'ак батаңыздарды берип кетүүгө чакырабыз!',
